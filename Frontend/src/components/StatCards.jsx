...
export const StatCards = ({ mrr, activeCount }) => {
  ...
  return (
    <div ref={containerRef} className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
      {/* Burn Rate Card */}
      <div className="glass-panel p-6 border-brand-rose/20 relative overflow-hidden group hover:-translate-y-1 hover:shadow-xl hover:shadow-brand-rose/10 active:scale-95 transition-all cursor-pointer">
      ...
      <div className="glass-panel p-6 border-brand-blue/20 relative overflow-hidden group hover:-translate-y-1 hover:shadow-xl hover:shadow-brand-blue/10 active:scale-95 transition-all cursor-pointer">
        <div className="absolute top-0 right-0 p-4 opacity-10 group-hover:opacity-20 transition-opacity">
      ...
      <div className="glass-panel p-6 border-brand-emerald/20 relative overflow-hidden group hover:-translate-y-1 hover:shadow-xl hover:shadow-brand-emerald/10 active:scale-95 transition-all cursor-pointer">
        <div className="absolute top-0 right-0 p-4 opacity-10 group-hover:opacity-20 transition-opacity">
