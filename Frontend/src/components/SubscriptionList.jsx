...
export const SubscriptionList = ({ subscriptions, onDelete }) => {
                        ...
                        <div className="flex flex-col md:flex-row gap-8">
                          ...
                          <div className="w-full md:w-64 space-y-3">
                             ...
                             <button 
                               ...
                               className="w-full py-2.5 px-4 rounded-lg bg-brand-rose/10 text-brand-rose hover:bg-brand-rose/20 transition-colors flex items-center justify-center gap-2 text-sm font-medium border border-brand-rose/20"
                             >
